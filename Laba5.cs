...
class Program
{
    ...
    // === УПРАЖНЕНИЕ 5.1 ===
    //Упражнение 5.1 Написать метод, возвращающий наибольшее из двух чисел. Входные параметры метода два целых числа. Протестировать метод. Ведите два числа:(5,8)
    static void task_1()
    {
    ...
    // === УПРАЖНЕНИЕ 5.2 ===
    //Упражнение 5.2 Написать метод, который меняет местами значения двух передаваемых параметров. Параметры передавать по ссылке.(воод не требуется)
    static void task_2()
    {
    ...
    // Вычисляет факториал числа n. Если число слишком большое — сообщает об ошибке (пример: 10)
    static void task_3()
    {
    ...
    // === УПРАЖНЕНИЕ 5.4 ===
    // Рекурсивный метод вычисления факториала (пример ввода 5)
    static void task_4()
    {
    ...
    // Метод, вычисляющий НОД двух и трёх чисел (воод не требуется)
    static void task_5()
    {
    ...
    // Рекурсивный метод вычисления n-го числа Фибоначчи (пример ввода:F(8)=21)
    static void task_6()
    {
